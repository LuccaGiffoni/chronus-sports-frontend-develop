...
const Step3Athlete = ({ data }: { data: any }) => {
    ...
    const [selectedGenderlegalGuardian, setSelectedGenderLegalGuardian] = useState<any>({} as any);
    ...
    const formik = useFormik({
        ...
        validationSchema: formType === "PF" ? customerRegisterValidation : customerRegisterAtlhetePJValidation,
        validateOnBlur: true,
                            ...
                            <div className="mb-6">
                                <form onSubmit={formik.handleSubmit} className="text-white">
                                    ...
                                    <div className="lg:max-w-[430px]">
                                        ...
                                        <div>
                                            <h2 className="not-italic font-normal text-base leading-[150%] text-[#EEEEEE] pb-[18px]">Como você quer se registrar</h2>

                                            <div className="flex pb-[24px] max-w-[350px]">
                                                <div className="w-max mr-4 flex">
                                                    <div className="text-sm leading-6 pr-4">
                                                        <label htmlFor="pf" className="not-italic font-normal text-base leading-[150%] text-neutral-400">
                                                            Pessoa física
                                                        </label>
                                                        {' '}
                                                        <span id="pf-description" className="text-gray-500">
                                                            <span className="sr-only">Pessoa física</span>
                                                        </span>
                                                    </div>
                                                    <div className="flex h-6 items-center">
                                                        <input id="pf" aria-describedby="activy-description" checked={!!formik.values.pf.length} name="pf" type="checkbox"
                                                ...
                                                <div className="w-max mr-4 flex">
                                                    <div className="text-sm leading-6 pr-4">
                                                        <label htmlFor="pj" className="not-italic font-normal text-base leading-[150%] text-neutral-400">
                                                            Pessoa jurídica
                                                        </label>
                                                        {' '}
                                                        <span id="pj-description" className="text-gray-500">
                                                            <span className="sr-only">Pessoa jurídica</span>
                                                        </span>
                                                    </div>

                                                    <div className="flex h-6 items-center">
                                                        <input id="pj" aria-describedby="activy-description" name="pj" type="checkbox" checked={!!formik.values.pj.length}
                                                            onChange={formik.handleChange}
                                                            onBlur={formik.handleBlur}
                                                            className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600" />
                                                    </div>
                                        ...
                                        <motion.div layout className="parent">
                                            {!!formik.values.pf.length && <div className="child lg:max-w-[430px]" >
                                                ...
                                                <div className="col-span-full pb-[24px]">
                                                    ...
                                                    <Select items={gender} key="gender" title="" data={{ formik, selected: selectedGender, setSelected: setSelectedGender, errors: (Object.keys(formik.errors).length > 0) }} />
                                                </div>
                                        ...
                                        >
                                            {!!formik.values.pj.length && <div className="child lg:max-w-[430px]" >
                                                <div>
                                                    <h2 className="not-italic font-normal text-base leading-[150%] text-[#EEEEEE] pb-7">Informações gerais</h2>
                                                    <div className="col-span-full pb-[24px]">
